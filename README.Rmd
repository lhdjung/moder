...
Ken Williams' [mode functions on Stack Overflow](https://stackoverflow.com/questions/2547402/how-to-find-the-statistical-mode/8189441#8189441) were pivotal to moder. Use `mode_first()` and `mode_all()` as drop-in replacements for `Mode()` and `Modes()`, respectively. They will behave equally unless some values are missing, although the source code is somewhat different.
