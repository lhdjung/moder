...
In the future, other metadata functions such as `mode_frequency()` might get a `max_unique` argument because this kind of information is relevant for them, as well.
