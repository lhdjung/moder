...
test_that("`remove_some_na()` throws an error when it should", {
  expect_error(remove_some_na(1:5, na.rm = TRUE,  na.rm.amount = 1))
  expect_error(remove_some_na(1:5, na.rm = FALSE, na.rm.amount = 0.5))
})
